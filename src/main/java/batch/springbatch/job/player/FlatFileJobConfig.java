package batch.springbatch.job.player;

import batch.springbatch.core.serivce.PlayerSalaryService;
import batch.springbatch.dto.PlayerDto;
import batch.springbatch.dto.PlayerSalaryDto;
...
public class FlatFileJobConfig {
    ...
    public FlatFileItemWriter<PlayerSalaryDto> playerFileItemWriter() throws IOException {
        ...
        FileSystemResource resouce = new FileSystemResource("player-salary-list.txt");
