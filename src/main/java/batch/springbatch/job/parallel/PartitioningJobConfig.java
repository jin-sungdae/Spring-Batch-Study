package batch.springbatch.job.parallel;
...
/**
 *  단일 프로세스에서 마스터 스텝과 우커 스텝을 두고, 마스터 스텝에서 생성해준 파티션 단위로 스텝을 병렬 처리한다.
 */
...
public class PartitioningJobConfig {
    ...
    private static final int PARTITION_SZIE = 100;
    ...
    public Partitioner partitioner() {
        ...
        partitioner.partition(PARTITION_SZIE);
        return partitioner;
    }
    ...
    public TaskExecutorPartitionHandler partitionHandler(Step anotherStep,
        ...
        partitionHandler.setGridSize(PARTITION_SZIE);
